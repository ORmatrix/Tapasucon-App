...
class FoodMenuAnDay2 extends StatefulWidget
{
  const FoodMenuAnDay2({super.key});
  @override
  State<FoodMenuAnDay2> createState() => _FoodMenuAnDay2State();

}
class _FoodMenuAnDay2State extends State<FoodMenuAnDay2> {
