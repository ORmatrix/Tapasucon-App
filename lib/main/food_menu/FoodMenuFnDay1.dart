...
class FoodMenuFnDay1 extends StatefulWidget
{
  const FoodMenuFnDay1({super.key});
  @override
  State<FoodMenuFnDay1> createState() => _FoodMenuFnDay1State();

}
class _FoodMenuFnDay1State extends State<FoodMenuFnDay1> {
